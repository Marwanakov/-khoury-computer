...
public class Product {
    ...
    public LocalDateTime getNewArrivalMarkedAt() {
        return newArrivalMarkedAt;
    }
    ...
    public void markAsNewArrival(LocalDateTime markedAt) {
        setNewArrivalState(true, markedAt);
    }

    public void removeNewArrivalStatus() {
        setNewArrivalState(false, null);
    }
