...
public class AdminProductController {
    ...
    public String showProductsPage(
        ...
        List<ProductResponse> products =
                productApplicationService.filterProducts(
                        keyword,
                        categoryId,
                        null,
                        status,
        ...
        Map<Long, CategoryResponse> categoriesById =
                categories.stream()
                        .collect(
                                Collectors.toMap(
                                        CategoryResponse::id,
    ...
    public String createProduct(
        ...
        try {
            ImageUpload imageUpload =
                    toImageUpload(productForm.getImage());
    ...
    public String showEditProductPage(
        ...
        ProductResponse product =
                productApplicationService.getProductById(
                        productId
                );
